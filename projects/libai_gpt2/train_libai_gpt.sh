...
if [ ! -s "${LIBAI_PWD}/libai/tools/args_train.sh" ]; then
  echo "==> get train sh"
  wget -nc  https://raw.githubusercontent.com/Oneflow-Inc/OneAutoTest/megatron_script_tecent/onebench/libai/args_train.sh -P ${LIBAI_PWD}/libai/tools/
else
